...
**Given that the conditions for inference have been met, We can reject the Null hypothesis (_Incomes do not differ between majors_), and accept the Alternative hypothesis (_Incomes do differ between majors). In other words, The major you decide to study has a significant influence over your potential earnings after graduation, so pick wisely.**
